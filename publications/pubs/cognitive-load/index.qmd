...
<button type="button" class="btn btn-primary btn-sm" onclick="window.open('https://raw.githubusercontent.com/cillianmiltown/website_quarto/main/publications/pubs/cognitive-load/cognitive-load.pdf');" data-inline="true" >PDF</button>
...
y1 <- y %>% dplyr::select("InCS","condition","pbar","se")
