...
<button type="button" class="btn btn-primary btn-sm" onclick="window.open('https://raw.githubusercontent.com/cillianmiltown/website_quarto/main/publications/pubs/moral-judgment-as-categorization/mjac.pdf');" data-inline="true" >PDF</button>
<button type="button" class="btn btn-primary btn-sm" onclick="window.open('https://journals.sagepub.com/doi/full/10.1177/1745691621990636');" data-inline="true" >Source Document</button>
